...
import { useGetCryptoDetailsQuery, useGetCryptoHistroyQuery } from '../services/cryptoApi'
...
const CryptoDetail = () => {
  ...
  const { data: coinHistory } = useGetCryptoHistroyQuery({ coinId, timePeriod });
